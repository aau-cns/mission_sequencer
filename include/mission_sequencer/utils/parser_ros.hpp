...
MissionSequencerOptions parse_ros_nodehandle(ros::NodeHandle& nh)
{
  ...
  nh.param("do_automatically_disarm", params.b_do_automatically_disarm_, params.b_do_automatically_disarm_);
  nh.param("do_automatically_land", params.b_do_automatically_land_, params.b_do_automatically_land_);
  nh.param("wp_are_relative", params.b_wp_are_relative_, params.b_wp_are_relative_);
  nh.param("wp_from_file", params.b_wp_from_file_, params.b_wp_from_file_);
  nh.param("verbose", params.b_do_verbose, params.b_do_verbose);
